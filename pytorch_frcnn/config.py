class Config:
    # 训练集路径,验证集路径
    # train_dir = 'data/BCCD'
    train_dir = 'data/VOC2020'
    # val_dir = 'data/BCCD'
    val_dir = 'data/VOC2020'
    # 最大和最小输入尺寸
    max_size = 1000
    min_size = 600
    ...
    # 注意Faster-RCNN中是有背景这一类的,但是这里及xml2txt都没有 '__background__'这一类,是因为Faster-RCNN在内部临时把所有的
    # label都+1,计算ap以及最后nms的时候又跳过label等于0的情况. 详情参见 ProposalTargetCreator 类 以及_suppress方法
    # class_name = ('aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable',
    #                               'dog', 'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor')
    # class_name = ('wbc', 'rbc', 'platelets')  # 转为小写了
    class_name = ('fire') # 转为小写了
